...
<div class="menu-container">
  ...
  <div class="menu-content" id="appetizer-content">
      ...
      <div class="items">
        ...
        <div class="item">
          <h4>Spicy Edamame</h4>
          <p>pan-fried soybeans with Japanese spice mix<br>6.50</p>
        </div>
        <div class="item">
          <h4>Green Salad</h4>
          <p>served with house dressing sauce<br>4.95</p>
        </div>
        <div class="item">
          <h4>Seaweed Salad</h4>
          <p>seaweed marinated with sesame oil<br>5.95</p>
        </div>
        <div class="item">
          <h4>Veggie Sunomono</h4>
          <p>cucumber in vinegar sauce<br>5.50</p>
        </div>
        <div class="item">
          <h4>Seafood Sunomono </h4>
          <p>cucumber with assorted seafood in vinegar sauce<br>7.95</p>
        </div>
        <div class="item">
          <h4>Hawaiian Poke</h4>
          <p>ahi tuna, cucumber, onion with ponzu, sesame oil, spicy sauce & tobiko<br>11.95</p>
        </div>
      </div>


      <div class="item-title">Grilled</div>

      <div class="items">
        <div class="item">
          <h4>Baked Green Mussel</h4>
          <p>baked on half shell & spicy sauce - 5 pcs<br>7.50</p>
        </div>
        <div class="item">
          <h4>BBQ Albacore</h4>
          <p>grilled rare white tuna with special spicy BBQ sauce - 6 pcs<br>14.95</p>
        </div>
        <div class="item">
          <h4>Sea Steak</h4>
          <p>grilled ahi tuna with ponzu & special sauce - 8 pcs<br>14.95</p>
        </div>
        <div class="item">
          <h4>Chicken Teriyaki</h4>
          <p>grilled chicken with teriyaki sauce<br>9.95</p>
        </div>
        <div class="item">
          <h4>Hamachi Kama</h4>
          <p>grilled yellow tail cheek bone with ponzu sauce<br>10.50</p>
        </div>
      </div>


      <div class="item-title">Deep-Fried</div>

      <div class="items">
        <div class="item">
          <h4>Agedashi Tofu</h4>
          <p>deep-fried tofu served with dried tuna, ponzu sauce<br>7.95</p>
        </div>
        <div class="item">
          <h4>Calamari Tempura</h4>
          <p>breaded deep-fried calamari ring<br>8.50</p>
        </div>
        <div class="item">
          <h4>Croquette</h4>
          <p>deep-fried potato & vegetables – 3pcs<br>6.50</p>
        </div>
        <div class="item">
          <h4>Creamy Jalapeno </h4>
          <p>deep-fried jalapeno, cream cheese, spicy tuna special sauce<br>6.95</p>
        </div>
        <div class="item">
          <h4>Gyoza</h4>
          <p>Deep-fried or steamed chicken and vegetable pot-stickers - 7 pcs<br>7.50</p>
        </div>
        <div class="item">
          <h4>Vegetable Tempura</h4>
          <p>assorted seasonal vegetables<br>7.50</p>
        </div>
        <div class="item">
          <h4>Shrimp Tempura</h4>
          <p>deep-fried shrimp - 4 pcs<br>9.95</p>
        </div>
        <div class="item">
          <h4>Mixed Tempura</h4>
          <p>shrimp - 2 pcs, vegetables - 5 pcs<br>8.95</p>
        </div>
        <div class="item">
          <h4>Honey Spice Chicken</h4>
          <p>pan fried chicken, honey spice sauce<br>9.95</p>
        </div>
        <div class="item">
          <h4>Sesame Chicken</h4>
          <p>tempura fried chicken, teriyaki sauce<br>9.95</p>
        </div>
      </div>


      <div class="item-title">Raw Fish</div>

      <div class="items">
        <div class="item">
          <h4>Kuma Oyster</h4>
          <p>half shell oyster with spicy ponzu sauce, lemon - 4 pcs<br>9.95</p>
        </div>
        <div class="item">
          <h4>Pepper Fin</h4>
          <p>white tuna with jalapeno, spicy ponzu sauce and sesame oil<br>14.95</p>
        </div>
        <div class="item">
          <h4>7 Pcs Sashimi</h4>
          <p>choice of one - salmon, tuna, yellowtail - 7 pcs<br>14.50</p>
        </div>
        <div class="item">
          <h4>Assorted Sashimi</h4>
          <p>chef's choice of today's raw fish - 12 pcs<br>19.95</p>
        </div>
        <div class="item">
          <h4>Garlic Sashimi</h4>
          <p>7pcs of salmon with fried garlic special sauce<br>14.95</p>
        </div>
        <div class="item">
          <h4>Hamachi Carpaccio</h4>
          <p>Sliced Hamachi jalapeno with chili pepper ponzu olive oil<br>14.95</p>
        </div>
      </div>
    </div>
  ...
  <div class="menu-content" id="street-food-content">
    ...
    <div class="items">
      <div class="item">
        <h4>Bulgogi Tacos </h4>
        <p>marinated Korean style beef, white/red cabbage, cilantro, (3pcs)<br>13.95</p>
      </div>

      <div class="item">
        <h4>Ahi Poke Tacos</h4>
        <p>seared ahi tuna, avocado, cilantro, white/red cabbage, sesame oil, special sauce (3pcs)<br>13.95</p>
      </div>

      <div class="item">
        <h4>Zig Zag Tacos</h4>
        <p>crispy soft shell crab, avocado, white/red cabbage, cilantro, zig zag sauce (3pcs)<br>12.95</p>
      </div>

      <div class="item">
        <h4>Vegetable Bibimbap </h4>
        <p>rice, seasonal vegetable, vinaigrette, sesame oil, Korean hot sauce/with miso soup<br>11.95</p>
      </div>

      <div class="item">
        <h4>Bulgogi Bibimbap</h4>
        <p>rice, marinated beef, seasonal vegetable, sesame oil, Korean hot sauce / with miso soup<br>13.95</p>
      </div>

      <div class="item">
        <h4>Tofu Bibimbap </h4>
        <p>rice, seasonal vegetable, tofu, vinaigrette, Korean hot sauce / with miso soup<br>12.95</p>
      </div>

      <div class="item">
        <h4>Vegetable Tempura Donburi</h4>
        <p>assorted seasonal vegetables  - 9pcs<br>12.95</p>
      </div>

      <div class="item">
        <h4>Tempura Donburi</h4>
        <p>shrimp - 3pcs and assorted seasonal vegetables - 7pcs<br>14.95</p>
      </div>

      <div class="item">
        <h4>Unagi Donburi</h4>
        <p>grilled eel over steamed rice with seaweed salad, vinaigrette, unagi sauce sesame seeds<br>21.95</p>
      </div>

      <div class="item">
        <h4>Bulgogi Donburi </h4>
        <p>marinated Korean style beef over steamed rice<br>15.95</p>
      </div>

      <div class="item">
        <h4>Sake Donburi </h4>
        <p>slices of raw salmon over steamed rice with seaweed salad vinaigrette, masago<br>21.95</p>
      </div>
  ...
  <div class="menu-content" id="entree-content">
    ...
    <div class="bento-items">
      ...
      <div class="item">Fish Katsu</div>
      <div class="item">Ton Katsu</div>
      <div class="item">Chicken Katsu</div>
      <div class="item">California Roll</div>
      <div class="item">Tuna Sashimi 4ps</div>
      <div class="item">Saba Shioyaki</div>
      <div class="item">Sake Nigiri 2pcs</div>
      <div class="item">Sesame Chicken</div>
      <div class="item">Gyoza - 4pc</div>
      <div class="item">Croquette – 2pcs</div>
      <div class="item">Bulgogi</div>
      <div class="item">Mixed Tempura (shrimp - 1pc , vegetable - 5pcs)</div>
    </div>

    <div class="item-title">NOODLE SOUP</div>
    <div class="items">
      <div class="item">
        <h4>Veggie Udon</h4>
    ...
    <div class="item-title">KUMA SINGLE ENTRÉE</div>
    <div class="items">
      <div class="item">
        <h4>Chicken Teriyaki</h4>
    ...
    <div class="item-title">Bowl Special</div>
    <div class="items">
      <div class="item">
        <h4>Ton Katsu</h4>
  ...
  <div class="menu-content" id="sns-content">
    ...
    <div class="items">
      ...
      <div class="item">
        ...
        <p>25 pcs chef’s choice of sliced raw fish<br>36.95</p>
      </div>
    </div>
  </div>
  ...
  <div class="menu-content" id="rolls-content">
    ...
    <div class="item-title">Temaki - Hand Roll</div>
    <div class="items">
      <div class="item">
      ...
      <div class="item">
        <h4>Hamachi Hand Roll</h4>
        <p>hamachi, green onion<br>8.99</p>
      </div>
  ...
  <div class="menu-content" id="ksr-content">
    ...
    <div class="items">
      <div class="item">
        <h4>Fair Way</h4>
        <p>Deep-fried shrimp | avocado, masago | special sauce<br>13.99</p>
      </div>

      <div class="item">
        <h4>Golden Gate</h4>
        <p>Deep-fried shrimp | crab meat, masago | special sauce<br>14.99</p>
      </div>

      <div class="item">
        <h4>Hwy 65</h4>
        <p>Crabmeat, avocado | cooked shrimp, masago | special sauce<br>15.99</p>
      </div>

      <div class="item">
        <h4>Chicken Teriyaki Roll</h4>
        <p>avocado, cream cheese, grilled chicken  | unagi sauce | 5pcs<br>13.99</p>
      </div>
    ...
    <div class="item-title">Eel</div>
    <div class="items">
      <div class="item">
        <h4>Benjaminn Roll</h4>
        <p>Spicy tuna, spicy crab meat, cilantro | unagi, masago | special sauce <br>16.99</p>
      </div>
      ...
      <div class="item">
        <h4>Caterpillar</h4>
        <p>Eel, cucumber | avocado | unagi sauce<br>16.99</p>
      </div>
      ...
      <div class="item">
        <h4>Spicy crunchy</h4>
        <p>Spicy tuna, eel, seaweed salad, cucumber | crunchy, unagi sauce | 5pcs <br>14.50</p>
      </div>
      ...
      <div class="item">
        <h4>Kamikaze</h4>
        <p>Spicy crab, jalapeno, cream cheese | cooked shrimp, eel, salmon, masago | special sauce<br>17.50</p>
      </div>
    </div>

    <div class="item-title">Raw</div>
    <div class="items">
      <div class="item">
        <h4>49er</h4>
      ...
      <div class="item">
        <h4>911</h4>
        <p>Spicy tuna, cucumber | tuna, masago | spicy & special sauce<br>15.50</p>
      </div>
      ...
      <div class="item">
        ...
        <p>Salmon, avocado | tuna, masago | special sauce<br>15.99</p>
      </div>

      <div class="item">
        <h4>Crazy Horse</h4>
        <p>Salmon, tuna, yellowtail, avocado, masago | special sauce - 5pcs<br>15.99</p>
      </div>
      ...
      <div class="item">
        <h4>Kiss Me</h4>
        <p>Crab meat, avocado | salmon, masago | special sauce<br>15.50</p>
      </div>
      ...
      <div class="item">
        ...
        <p>Tuna, avocado | salmon, masago | special sauce<br>15.99</p>
      </div>
      ...
      <div class="item">
        <h4>Rainbow</h4>
        <p>Crab meat, avocado | 5 kinds of raw fish<br>17.50</p>
      </div>

      <div class="item">
        <h4>Playboy</h4>
        <p>Spicy tuna, spicy crab meat, cilantro | salmon, lemon, masago<br>17.50</p>
      </div>
      ...
      <div class="item">
        <h4>Sunrise</h4>
        <p>Spicy crab, Salmon, tuna, yellowtail, avo | spicy& special sauce - 5pcs<br>16.99</p>
      </div>
      ...
      <div class="item">
        <h4>Viagra</h4>
        <p>Spicy tuna, spicy crab meat, | tuna, salmon, yellowtail, masago | spicy & special sauce<br>16.99</p>
      </div>
    </div>

    <div class="item-title">Seared</div>
    <div class="items">
      <div class="item">
        <h4>Aloha</h4>
        <p>Spicy tuna, spicy crab meat, cucumber | seared albacore, jalapeno, masago | special sauce<br>15.99</p>
      </div>
      ...
      <div class="item">
        <h4>Sakura</h4>
        <p>Spicy tuna, spicy crab meat, jalapeno | seared tuna, cooked shrimp, masago | special sauce<br>16.99</p>
      </div>
    ...
    <div class="item-title">Baked</div>
    <div class="items">
      <div class="item">
        <h4>Lion King </h4>
        <p>Crab meat, avocado | salmon, special sauce & masago added after cooking - 6pcs<br>14.50</p>
      </div>
